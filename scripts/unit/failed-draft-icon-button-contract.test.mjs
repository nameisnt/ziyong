...
const file = 'src/components/FailedDraftList.vue';
const source = await readFile(new URL('../../src/components/FailedDraftList.vue', import.meta.url), 'utf8');

test('the Failed Draft icon button has the same accessible name as its title', () => {
