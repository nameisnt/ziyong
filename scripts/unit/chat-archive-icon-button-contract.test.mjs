...
const file = 'src/apps/archive/ChatArchiveApp.vue';
const source = await readFile(new URL('../../src/apps/archive/ChatArchiveApp.vue', import.meta.url), 'utf8');

test('every Chat Archive icon button has the same accessible name as its title', () => {
