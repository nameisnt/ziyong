...
const file = 'src/apps/media/MediaGenerateApp.vue';
const source = await readFile(new URL('../../src/apps/media/MediaGenerateApp.vue', import.meta.url), 'utf8');

test('the media generation icon button has the same accessible name as its title', () => {
