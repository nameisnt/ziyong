...
const file = 'src/apps/storylines/StorylineEditorPage.vue';
const source = await readFile(new URL('../../src/apps/storylines/StorylineEditorPage.vue', import.meta.url), 'utf8');

test('every Storylines editor icon button has the same accessible name as its title', () => {
