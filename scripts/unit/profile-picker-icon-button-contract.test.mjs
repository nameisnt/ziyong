...
const file = 'src/components/ProfileEntryPicker.vue';
const source = await readFile(new URL('../../src/components/ProfileEntryPicker.vue', import.meta.url), 'utf8');

test('the Profile Entry Picker icon button has the same accessible name as its title', () => {
