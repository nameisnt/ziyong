...
const file = 'src/components/SearchableCombobox.vue';
const source = await readFile(new URL('../../src/components/SearchableCombobox.vue', import.meta.url), 'utf8');

test('the Searchable Combobox icon button has the same accessible name as its title', () => {
