...
const file = 'src/apps/cloud-media/CloudMediaApp.vue';
const source = await readFile(new URL('../../src/apps/cloud-media/CloudMediaApp.vue', import.meta.url), 'utf8');

test('every Cloud Media icon button has the same accessible name as its title', () => {
