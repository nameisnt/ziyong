...
const file = 'src/apps/preset-link/PresetLinkApp.vue';
const source = await readFile(new URL('../../src/apps/preset-link/PresetLinkApp.vue', import.meta.url), 'utf8');

test('the Preset Link icon button has the same accessible name as its title', () => {
