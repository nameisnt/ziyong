...
const file = 'src/apps/regex-display/RegexDisplayApp.vue';
const source = await readFile(new URL('../../src/apps/regex-display/RegexDisplayApp.vue', import.meta.url), 'utf8');

test('every Regex Display icon button has the same accessible name as its title', () => {
