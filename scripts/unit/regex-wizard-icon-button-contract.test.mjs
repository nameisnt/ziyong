...
const file = 'src/apps/regex-wizard/RegexWizardApp.vue';
const source = await readFile(new URL('../../src/apps/regex-wizard/RegexWizardApp.vue', import.meta.url), 'utf8');

test('every Regex Wizard icon button has the same accessible name as its title', () => {
