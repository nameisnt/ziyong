...
const file = 'src/apps/settings/SettingsConnectionPanel.vue';
const source = await readFile(new URL('../../src/apps/settings/SettingsConnectionPanel.vue', import.meta.url), 'utf8');
