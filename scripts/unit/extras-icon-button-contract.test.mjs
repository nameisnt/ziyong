...
const file = 'src/apps/extras/ExtrasBookOverviewPage.vue';
const source = await readFile(new URL('../../src/apps/extras/ExtrasBookOverviewPage.vue', import.meta.url), 'utf8');
