...
const file = 'src/apps/gallery/GalleryApp.vue';
const source = await readFile(new URL('../../src/apps/gallery/GalleryApp.vue', import.meta.url), 'utf8');

test('every Gallery icon button has the same accessible name as its title', () => {
