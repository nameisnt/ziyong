...
test('all approved A-group list surfaces expose item import', () => {
  const cases = [
    ['src/apps/summary/SummaryBookPage.vue', 'app-id="summary"'],
    ['src/apps/diary/DiaryBookPage.vue', 'app-id="diary"'],
    ['src/apps/extras/ExtrasBookOverviewPage.vue', 'app-id="extras"'],
    ['src/apps/forum/ForumBoardPage.vue', 'app-id="forum"'],
