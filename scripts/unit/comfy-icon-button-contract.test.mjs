...
const file = 'src/apps/comfy/ComfyApp.vue';
const source = await readFile(new URL('../../src/apps/comfy/ComfyApp.vue', import.meta.url), 'utf8');

test('every Comfy icon button has the same accessible name as its title', () => {
