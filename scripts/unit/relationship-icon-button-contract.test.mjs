...
const file = 'src/apps/relationship/RelationshipApp.vue';
const source = await readFile(new URL('../../src/apps/relationship/RelationshipApp.vue', import.meta.url), 'utf8');

test('every Relationship icon button has the same accessible name as its title', () => {
