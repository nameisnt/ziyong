...
const file = 'src/apps/video/VideoApp.vue';
const source = await readFile(new URL('../../src/apps/video/VideoApp.vue', import.meta.url), 'utf8');

test('every Video icon button has the same accessible name as its title', () => {
