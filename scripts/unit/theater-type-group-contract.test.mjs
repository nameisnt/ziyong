...
const promptsSource = await readMaybe(new URL('../../src/apps/prompts/PromptsApp.vue', import.meta.url));
const editorSource = await readMaybe(new URL('../../src/apps/prompts/PromptTypeEditorPage.vue', import.meta.url));
