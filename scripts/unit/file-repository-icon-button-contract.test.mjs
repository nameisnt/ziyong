...
const file = 'src/apps/file-repository/FileRepositoryApp.vue';
const source = await readFile(new URL('../../src/apps/file-repository/FileRepositoryApp.vue', import.meta.url), 'utf8');

test('the file repository icon button has the same accessible name as its title', () => {
