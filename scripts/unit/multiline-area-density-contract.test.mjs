...
const files = {
  ...
  extras: await readFile(new URL('../../src/components/ExtrasApp.vue', import.meta.url), 'utf8'),
  forumThread: await readFile(new URL('../../src/components/forum/ForumThreadGeneratePage.vue', import.meta.url), 'utf8'),
