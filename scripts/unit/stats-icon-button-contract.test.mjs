...
const file = 'src/components/StatsApp.vue';
const source = await readFile(new URL('../../src/components/StatsApp.vue', import.meta.url), 'utf8');

test('every Stats icon button has the same accessible name as its title', () => {
