...
const file = 'src/apps/theme/ThemeApp.vue';
const source = await readFile(new URL('../../src/apps/theme/ThemeApp.vue', import.meta.url), 'utf8');

test('every Theme icon button has the same accessible name as its title', () => {
