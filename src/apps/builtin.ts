import BaguApp from '@/apps/bagu/BaguApp.vue';
import ChatArchiveApp from '@/apps/archive/ChatArchiveApp.vue';
import DiaryApp from '@/apps/diary/DiaryApp.vue';
import ExtrasApp from '@/apps/extras/ExtrasApp.vue';
import FavoritesApp from '@/apps/favorites/FavoritesApp.vue';
import ForumApp from '@/apps/forum/ForumApp.vue';
import LettersApp from '@/apps/letters/LettersApp.vue';
import PromptsApp from '@/apps/prompts/PromptsApp.vue';
import ReaderApp from '@/apps/reader/ReaderApp.vue';
import SettingsApp from '@/apps/settings/SettingsApp.vue';
import StatsApp from '@/apps/stats/StatsApp.vue';
import SummaryApp from '@/apps/summary/SummaryApp.vue';
import TheaterApp from '@/apps/theater/TheaterApp.vue';
