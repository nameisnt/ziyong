...
export const RELEASE_HISTORY = [
  ...
  },
  {
    ...
    notes: [
      ...
      '组合导入支持内容预览、附件选择、同名跳过或另存为，以及符合条件的资源替换；失败项可单独重试，已成功项目不重复导入。',
      '预设组合包保留条目顺序、分组和附件配置；导入不自动切换当前预设，附带助手脚本和新增全局正则默认停用。',
      '修复新角色卡首次导入聊天时因聊天目录尚未初始化而失败的问题；聊天导入失败显示明确提示，不再只显示 true。',
      '扩展迁移改为逐个安装；安装冲突会核实目录、安装范围和仓库来源，只有确认同一扩展已安装才跳过，其他错误保留以便重试。',
    ],
  },
  {
    version: '1.2.6',
